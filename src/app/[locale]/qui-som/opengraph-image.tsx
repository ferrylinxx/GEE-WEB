...
const texts: Record<string, { section: string; title: string; desc: string }> = {
  ca: {
    section: "L'equip",
    title: "Qui som",
    desc: "Economistes i arquitectes especialitzats en consultoria econòmica i territorial a Barcelona",
  },
  es: {
    section: "El equipo",
    title: "Quiénes somos",
    desc: "Economistas y arquitectos especializados en consultoría económica y territorial en Barcelona",
  },
  en: {
    section: "The Team",
    title: "Who we are",
    desc: "Economists and architects specialised in economic and territorial consulting in Barcelona",
  },
};
